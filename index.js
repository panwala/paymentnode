...
app.post('/checkout', (req, res) => {
    ...
    const { cc, cvv, expire, amount,name } = req.body;
            ...
            if(response.getMessages().getResultCode() === ApiContracts.MessageTypeEnum.OK) {
                if(response.getTransactionResponse().getMessages() !== null) {
                    res.json({ success: 'Transaction was successful.', 
                            ...
                            name,
                            Account_number:apiResponse.transactionResponse.accountNumber,
                            Account_type:apiResponse.transactionResponse.accountType,
                            Transaction_id:apiResponse.transactionResponse.transId,
